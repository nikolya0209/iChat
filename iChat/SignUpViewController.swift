...
class SignUpViewController: UIViewController {
    ...
    let welkomeLabel = UILabel(text: "Good to see you!", font: .avenir26())
...
extension SignUpViewController {
    ...
    private func setupConstraints() {
        ...
        let bottomStackView = UIStackView(arrangedSubviews: [alreadyOnboardLabel, loginButton],
                                          axis: .horizontal,
                                          spacing: -1)
        welkomeLabel.translatesAutoresizingMaskIntoConstraints = false
        stackView.translatesAutoresizingMaskIntoConstraints = false
        bottomStackView.translatesAutoresizingMaskIntoConstraints = false
        
        view.addSubview(welkomeLabel)
        view.addSubview(stackView)
        view.addSubview(bottomStackView)
        
        NSLayoutConstraint.activate([
            welkomeLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 160),
            welkomeLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor)
        ])
        
        NSLayoutConstraint.activate([
            stackView.topAnchor.constraint(equalTo: welkomeLabel.bottomAnchor, constant: 160),
